...
/**
 * This exception will be thrown by {@link DefaultEventBinder#bind(Object, Object)}
 * when the binder is in strict binding mode and any of the found event
 * targets cannot be bound to an event source.
 * 
 * @author Frank Hardy
 */
