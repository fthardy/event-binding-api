...
/**
 * An event binding is a context object which represents an event binding
 * between a source and a target object.<br/>
 * An event binding provides access to the object which represents source and
 * target of the event binding and allows to release the binding between those
 * two by calling {@link #release()}.
 * 
 * @author Frank Hardy
 */
