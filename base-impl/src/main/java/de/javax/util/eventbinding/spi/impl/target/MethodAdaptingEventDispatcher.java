...
public class MethodAdaptingEventDispatcher implements EventDispatcher {
    ...
    public MethodAdaptingEventDispatcher(Method method, Object instance) {
        ...
        if (Modifier.isStatic(method.getModifiers())) {
            ...
            if (instance != null) {
                assert this.method.getDeclaringClass().isInstance(instance) : "The given method is not a method of the given object instance!";
            }
    ...
    public String toString() {
        String className = this.instance == null ? this.method.getDeclaringClass().getName() : this.instance.getClass()
                .getName();

        StringBuilder builder = new StringBuilder(this.method.toGenericString()).append(" @ ").append(className);
    ...
    /**
     * Will be thrown by
     * {@link MethodAdaptingEventDispatcher#dispatchEvent(Object)} when the
     * invokation of the event receiver method fails.
     * 
     * @author Frank Hardy
     */
