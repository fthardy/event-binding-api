...
public class GenericEventBindingConnector implements EventBindingConnector {
	...
	public GenericEventBindingConnector(Object eventSource, Method addMethod,
			Method removeMethod, Method eventMethod, Class<?> listenerType) {
	...
	public void connect(final EventDispatcher eventDispatcher) {
		...
		this.listener = Proxy.newProxyInstance(Thread.currentThread()
				.getContextClassLoader(), new Class<?>[] { listenerType },
					...
					public Object invoke(Object proxy, Method method,
						...
						if (declaringClass == Object.class) {
							if (method.equals(hashCodeMethod)) {
								...
								throw new EventSourceAccessException(
							...
							if (eventMethod.equals(method)) {
								...
								throw new EventSourceAccessException(
										"unexpected listener method dispatched: "
												+ method);
							}
						}
					}
		...
		try {
			...
			throw new EventSourceAccessException(
					"registering event listener failed", e);
		}
	}
	...
	public void disconnect() {
		if (listener != null) {
			try {
				...
				throw new EventSourceAccessException(
						"unregistering event listener failed", e);
			}
			this.listener = null;
		}
	}
